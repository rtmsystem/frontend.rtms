...
const MatchTab = ({ matches }: MatchTabProps) => {
    ...
    const handleGenerateMatches = async () => {
        ...
        try {
            const response = await fetchApi(`/matches/generate-bracket/`, {
                method: 'POST',
                headers: {
                        ...
                        <>
                            {
                                filteredMatches?.length > 0 ? (
                                   <>
                                    ...
                                    <GenerateMatchesCard selectedDivision={divisions[selectedCategoryIndex]} handleGenerateMatches={handleGenerateMatches} generateMatchesLoading={generateMatchesLoading} />
                                )
                            }
                        </>
                    ) : 
